...
def varying_initial_conditions(L_sim, times_sim, d_sim, batch_size, procs_sim, batch_procs_num):
    ...
    experiment = dimers_sim.Experiment(file_name,
                                      "analyses/" + dir_name,
                                      results,
                                      description='Varying initialposition size experiment for L={}, times={}, d={}, batch_size={}'.format(L_sim, times_sim, d_sim, batch_size))
